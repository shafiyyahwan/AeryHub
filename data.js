...
const PRODUCTS = [
  ...
  { id: 6, name: "Tembikai Seedles", category: "Fruits", stock: 48, rating: 4.8, reviews: 156, sold: 410, farmerId: 10, harvestDate: "2026-05-28", organic: false, description: "Tembikai merah tanpa biji yang manis, gred A, sesuai untuk cuaca panas Malaysia.", images: ["https://images.unsplash.com/photo-1563114773-84221bd62daa?w=400&h=400&fit=crop"], tags: ["sweet", "refreshing", "buah"], pricing: [{ label: "Saiz S (2-3kg)", price: 12.00 }, { label: "Saiz M (4-5kg)", price: 19.50 }, { label: "Saiz L (6kg+)", price: 26.00 }] },
  { id: 7, name: "Buah Naga Merah", category: "Fruits", stock: 200, rating: 4.6, reviews: 93, sold: 1150, farmerId: 8, harvestDate: "2026-05-31", organic: false, description: "Buah naga isi merah organik dari Kuala Pilah. Manis gred premium.", images: ["https://images.unsplash.com/photo-1527325678964-54921661f888?w=400&h=400&fit=crop"], tags: ["sweet", "antioxidant", "buah"], pricing: [{ label: "1kg (2-3 biji)", price: 9.50 }, { label: "3kg (Kotak Borong)", price: 26.00 }] },
  ...
  { id: 10, name: "Terung Panjang", category: "Vegetables", stock: 88, rating: 4.5, reviews: 42, sold: 620, farmerId: 3, harvestDate: "2026-05-30", organic: false, description: "Terung panjang ungu segar dari Ipoh, berkulit nipis dan empuk apabila dimasak.", images: ["https://images.unsplash.com/photo-1587132137056-bfbf0166836e?w=400&h=400&fit=crop"], tags: ["fresh", "local", "sayur"], pricing: [{ label: "500g", price: 4.50 }, { label: "1kg", price: 8.00 }] },
  { id: 11, name: "Timun Jepun Cameron", category: "Vegetables", stock: 175, rating: 4.6, reviews: 67, sold: 1430, farmerId: 2, harvestDate: "2026-06-02", organic: true, description: "Timun Jepun premium rangup tinggi kandungan air, ditanam secara hidroponik.", images: ["https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=400&h=400&fit=crop"], tags: ["crispy", "organic", "hidroponik"], pricing: [{ label: "500g", price: 3.80 }, { label: "1kg", price: 7.00 }] },
  ...
  { id: 13, name: "Serai Kampung Segar", category: "Herbs", stock: 220, rating: 4.7, reviews: 98, sold: 2310, farmerId: 9, harvestDate: "2026-06-01", organic: true, description: "Batang serai wangi kampung segar gred masakan dari Rawang.", images: ["https://images.unsplash.com/photo-1598965402089-897ce52e8355?w=400&h=400&fit=crop"], tags: ["aromatic", "cooking", "fresh"], pricing: [{ label: "250g (approx 5-7 batang)", price: 2.50 }, { label: "1kg", price: 8.50 }] },
  { id: 14, name: "Ikan Siakap Sangkar", category: "Aquaculture products", stock: 65, rating: 4.9, reviews: 142, sold: 3240, farmerId: 10, harvestDate: "2026-06-02", organic: false, description: "Ikan Siakap hidup dari ternakan sangkar air masin Banting. Isi manis, bersih tanpa bau lumpur. Disiang percuma sebelum penghantaran.", images: ["https://images.unsplash.com/photo-1534604973900-c43ab4c2e0ab?w=400&h=400&fit=crop"], tags: ["aquaculture", "seafood", "fresh-fish"], pricing: [{ label: "600g - 800g (1 ekor)", price: 16.80 }, { label: "900g - 1.1kg (1 ekor)", price: 23.50 }] },
  { id: 15, name: "Udang Harimau Kolam Gred A", category: "Aquaculture products", stock: 45, rating: 4.8, reviews: 92, sold: 1410, farmerId: 10, harvestDate: "2026-06-02", organic: false, description: "Udang Harimau (Tiger Prawn) ternakan air payau premium, ditangkap segar mengikut pesanan. Kulit keras berkilat, isi padat mantap.", images: ["https://images.unsplash.com/photo-1551248429-40975aa4de74?w=400&h=400&fit=crop"], tags: ["aquaculture", "prawns", "premium"], pricing: [{ label: "300g (approx 10-12 ekor)", price: 24.00 }, { label: "600g (approx 20-24 ekor)", price: 46.00 }] }
];
